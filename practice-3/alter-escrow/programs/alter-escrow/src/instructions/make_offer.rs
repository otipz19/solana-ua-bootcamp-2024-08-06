...
use anchor_spl::{
    ...
    token::{approve_checked, ApproveChecked},
...
pub fn make_approve(context: &Context<MakeOffer>, token_a_offered_amount: u64) -> Result<()> {
...
pub fn save_offer(context: Context<MakeOffer>, token_a_offered_amount: u64, token_b_wanted_amount: u64, id: u64) -> Result<()> {
    context.accounts.offer.set_inner(Offer {
        ...
        token_a_delegated_amount: token_a_offered_amount,
